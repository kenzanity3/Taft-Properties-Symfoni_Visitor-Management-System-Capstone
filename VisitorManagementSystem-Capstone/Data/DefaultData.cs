    ...
    public static class DefaultData
    {
        ...
        public static List<VisitLog> DefaultVisitLog => new List<VisitLog>
        {
            new VisitLog
            {
                ...
                CheckInOutId = null,
                VisitorUserId = DefaultVisitors[0].UserId,
        ...
        public static List<User> DefaultUsers { get; } = new List<User>
        {
            ...
            new User
            {
                UserId = $"VIS-{DateTime.Now.Year}-00002",
                FirstName = "Default",
                MiddleName = "-",
                LastName = "Visitor",
            ...
            new User
            {
                UserId = $"VIS-{DateTime.Now.Year}-00003",
                FirstName = "Default",
                MiddleName = "-",
                LastName = "Visitor",
            ...
            new User
            {
                UserId = $"VIS-{DateTime.Now.Year}-00004",
                FirstName = "Default",
                MiddleName = "-",
                LastName = "Visitor",
            ...
            new User
            {
                UserId = $"RMW-{DateTime.Now.Year}-00001",
                FirstName = "Default",
                MiddleName = "-",
                LastName = "Owner",
        ...
        public static List<Visitor> DefaultVisitors { get; } = new List<Visitor> {
            new Visitor
            {
                UserId = $"VIS-{DateTime.Now.Year}-00001",
